...
export default function StudentsClient({ initialData }: { initialData: any[] }) {
    const [students, setStudents] = useState<any[]>(initialData)
    ...
    // Load students on demand if doing manual refresh
    // useEffect is removed because data comes instantly from server
